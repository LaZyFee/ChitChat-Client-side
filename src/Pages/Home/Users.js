...
const Users = ({ selectedUser, setSelectedUser }) => {
    ...
    //                 if (message.sender && message.sender._id && message.receiver && message.receiver._id) {
    //                     if (message.sender._id === loggedInUserId) {
    //                         uniqueUserObj[message.receiver._id] = message.receiver;
    //                     } else if (message.receiver._id === loggedInUserId) {
    //                         uniqueUserObj[message.sender._id] = message.sender;
    //                     }
    //                 }
    //             });
